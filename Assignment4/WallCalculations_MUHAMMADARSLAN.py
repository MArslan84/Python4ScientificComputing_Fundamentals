...
import os
os.chdir("G:\Assgn4")  #Adress for Calling function from first file
import File1 as u
...
Uwall=u.wallCalc_LIS()
Udoor=u.wallCalc_DR()["U-Value of Door"]
Uroof=u.wallCalc_DR()["U-value of Roof"]
